...
export const nav = [
  ...
  {
    path: "/projectplan/?project_id=null",
    element: <ProjectPlan2 />,
    isPrivate: true,
    isAdmin: true,
    isManager: true,
